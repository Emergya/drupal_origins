 ...
 * Enabled modules and additional settings.
 ...
 enable some basic drupal modules, and their dependencies, it is focused at site
 development.
 ...
 ENABLED MODULES AND ADDITIONAL SETTINGS
 --------------------------------------
 As it was said at "Introduction" section, drupal origins devel extension enable
